...
data = data[(data["dataset"].isin(datasets)) & (data["column_share"] == 100) & (data["row_share"] == 100) & (data["ignore_short"] == True)]
...
plt.savefig(pathlib.Path(write_path / "competitor_ed.pdf"), bbox_extra_artists=(t1, t2), dpi=300, bbox_inches='tight')
#plt.show()
